...
def get_enum_type() -> Union[sa.Enum, postgresql.ENUM]:
    if op.get_bind().dialect.name == 'postgresql':
        enum = postgresql.ENUM('LIMITS', 'USAGE', name='poolresourcesmetricsdimensions', create_type=False)

        enum.create(op.get_bind())

        return enum

    return sa.Enum('LIMITS', 'USAGE', name='poolresourcesmetricsdimensions')
