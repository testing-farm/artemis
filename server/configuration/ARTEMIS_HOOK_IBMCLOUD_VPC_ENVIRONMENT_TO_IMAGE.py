...
from tft.artemis.drivers.ibmcloudvpc import KNOB_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH, \
    KNOB_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE, IBMCloudVPCDriver
from tft.artemis.environment import Environment


def hook_IBMCLOUD_VPC_ENVIRONMENT_TO_IMAGE(
    *,
