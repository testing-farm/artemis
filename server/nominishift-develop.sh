...
export ARTEMIS_HOOK_AWS_FLAVOR_FILTERS="${ARTEMIS_HOOK_AWS_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_AWS_FLAVOR_FILTERS.py}"
export ARTEMIS_HOOK_AZURE_FLAVOR_FILTERS="${ARTEMIS_HOOK_AZURE_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_AZURE_FLAVOR_FILTERS.py}"
export ARTEMIS_HOOK_GCP_FLAVOR_FILTERS="${ARTEMIS_HOOK_GCP_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_GCP_FLAVOR_FILTERS.py}"
export ARTEMIS_HOOK_IBMCLOUD_POWER_FLAVOR_FILTERS="${ARTEMIS_HOOK_IBMCLOUD_POWER_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_IBMCLOUD_POWER_FLAVOR_FILTERS.py}"
export ARTEMIS_HOOK_IBMCLOUD_VPC_FLAVOR_FILTERS="${ARTEMIS_HOOK_IBMCLOUD_VPC_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_IBMCLOUD_VPC_FLAVOR_FILTERS.py}"
export ARTEMIS_HOOK_OPENSTACK_FLAVOR_FILTERS="${ARTEMIS_HOOK_OPENSTACK_FLAVOR_FILTERS:-$ARTEMIS_CONFIG_DIR/ARTEMIS_HOOK_OPENSTACK_FLAVOR_FILTERS.py}"
