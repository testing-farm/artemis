...
if [ -f "$ARTEMIS_CONFIG_DIR/.vault_pass" ]; then
    export ARTEMIS_VAULT_PASSWORD="$(cat "$ARTEMIS_CONFIG_DIR/.vault_pass")"
fi
...
export ARTEMIS_AWS_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH="${ARTEMIS_AWS_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH:-ARTEMIS_CONFIG_DIR/artemis-image-map-aws.yaml}"
export ARTEMIS_AZURE_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH="${ARTEMIS_AZURE_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH:-ARTEMIS_CONFIG_DIR/artemis-image-map-azure.yaml}"
export ARTEMIS_BEAKER_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH="${ARTEMIS_BEAKER_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH:-ARTEMIS_CONFIG_DIR/artemis-image-map-beaker.yaml}"
export ARTEMIS_OPENSTACK_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH="${ARTEMIS_OPENSTACK_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH:-ARTEMIS_CONFIG_DIR/artemis-image-map-openstack.yaml}"
