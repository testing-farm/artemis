...
class FlasherDriver(PoolDriver):
    ...
    @guest_log_updater('flasher', 'flasher-debug:dump', GuestLogContentType.URL)  # type: ignore[arg-type]
    ...
    @guest_log_updater('flasher', 'flasher-event:dump', GuestLogContentType.URL)  # type: ignore[arg-type]
