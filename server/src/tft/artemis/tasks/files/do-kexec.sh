...
# Arm kexec
kexec -l /tmp/vmlinuz --initrd /tmp/initrd.img --command-line="no_timer_check net.ifnames=0 console=tty1 console=ttyS0,115200n8 inst.ks=file:/${KS_FILENAME} inst.sshd inst.repo=$4 inst.noverifyssl ${CMDLINE}"
