...
class Workspace(_Workspace):
    ...
    TASKNAME = 'refresh-pool-resources-metrics'
    ...
    def run(self) -> None:
        ...
        with self.transaction():
            ...
            r_refresh = pool.refresh_pool_resources_metrics(self.logger, self.session)
...
def refresh_pool_resources_metrics(poolname: str) -> None:
    task_core_v2(
        cast(DoerType, Workspace.refresh_pool_resources_metrics),
