...
from . import _update_guest_state_and_request_task_v2, get_guest_logger, get_shelf_logger, step, task, task_core
...
class Workspace(_Workspace):
    ...
    def run(self) -> None:
        with self.transaction():
            ...
            self.load_shelf_v2(self.shelfname, state=GuestState.CONDEMNED)
