...
#
# In the Python data structures, constraints are stored in mappings where keys are nams of constraints, and values
...
class FlavorCpu:
    """
    Represents a HW properties related to CPU and CPU cores of a flavor.
...
class Flavor:
    """
    Represents a HW properties related a flavor.
    """
