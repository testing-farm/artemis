...
class _PoolDataMapping:
    ...
    def mine_or_none(self, pool: 'PoolDriver[Any, Any]', pool_data_class: type[PoolDataT]) -> Optional[PoolDataT]:
        return self.one_or_none(pool.poolname, pool_data_class)

    def mine(self, pool: 'PoolDriver[Any, Any]', pool_data_class: type[PoolDataT]) -> PoolDataT:
