...
try:
    artemis_version = pkg_resources.get_distribution('tft-artemis-cli').version
...
# See https://pypi.org/project/sphinx-autodoc-typehints/ for details.
# set_type_checking_flag = True  # DO NOT ENABLE! Breaks autodoc, some wird gluetool import issue.
