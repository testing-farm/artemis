...
|`int`
|`ARTEMIS_IBMCLOUD_VPC_DEFAULT_GUEST_PARTITION_SIZE`
|`42`
|no


|`ibmcloud.guests.default-root-partition-size:$entityname`
|
|`ARTEMIS_IBMCLOUD_VPC_DEFAULT_GUEST_PARTITION_SIZE_$entityname`
|
|


5+|Default boot volume partition size in GB for ibmcloud vpc guests
