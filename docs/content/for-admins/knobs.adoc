...
|`str`
|`ARTEMIS_AZURE_INSTANCE_NAME_TEMPLATE`
|`artemis-{{ GUESTNAME }}`
|no


|`azure.mapping.instance-name.template:$entityname`
|
|`ARTEMIS_AZURE_INSTANCE_NAME_TEMPLATE_$entityname`
|
|
...
|`str`
|`ARTEMIS_IBMCLOUD_INSTANCE_NAME_TEMPLATE`
|`artemis-{{ GUESTNAME }}`
|no
...
|
|`ARTEMIS_IBMCLOUD_INSTANCE_NAME_TEMPLATE_$entityname`
|
|
