...
|`str`
|`ARTEMIS_ENVIRONMENT_PATCH_MAPPING_FILEPATH`
|`None`
|no


|`pool.environment-patch-mapping-filepath:$entityname`
|
|`ARTEMIS_ENVIRONMENT_PATCH_MAPPING_FILEPATH_$entityname`
|
|


5+|Path of the environment patching mapping
