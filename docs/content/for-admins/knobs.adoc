...
|`aws.mapping.environment-to-image:$poolname`
|
...
|`azure.mapping.environment-to-image:$poolname`
|
...
|`beaker.mapping.environment-to-image:$poolname`
|
...
|`openstack.mapping.environment-to-image:$poolname`
|
