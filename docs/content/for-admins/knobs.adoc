...
|`int`
|`ARTEMIS_POOL_INSTANCES_PER_REQUEST_LIMIT`
|`7`
|no


|`pool.instances-per-request-limit:$entityname`
|
|`ARTEMIS_POOL_INSTANCES_PER_REQUEST_LIMIT_$entityname`
|
|


5+|Maximum number of instances allowed to be present in cloud simultaneously for a single guest request
