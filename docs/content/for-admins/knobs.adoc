...
|`gcp.mapping.environment-to-image.pattern-map.filepath:$poolname`
|
|`ARTEMIS_GCP_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH_$poolname`
|
|
...
|`gcp.mapping.environment-to-image.pattern-map.needle:$poolname`
|
|`ARTEMIS_GCP_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE_$poolname`
|
|
