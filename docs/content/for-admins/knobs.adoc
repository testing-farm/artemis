...
|`str`
|`ARTEMIS_GUEST_REQUEST_RESOURCE_DIGEST_TEMPLATE`
|`
...
|`guest_request.resource-digest-template:$entityname`
|
|`ARTEMIS_GUEST_REQUEST_RESOURCE_DIGEST_TEMPLATE_$entityname`
|
|


5+|A template for guest request summary information attached to resource tracking events.
