...
|`bool`
|`ARTEMIS_ROUTE_POOL_LEAST_CROWDED_FLAVOR`
|`no`
|yes


|`route.pool.least-crowded-flavor:$entityname`
|
|`ARTEMIS_ROUTE_POOL_LEAST_CROWDED_FLAVOR_$entityname`
|
|


5+|When enabled, prefer the least crowded (least used) flavor from suitable candidates.
