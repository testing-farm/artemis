...
|`aws.mapping.environment-to-image.pattern-map.filepath:$poolname`
|
|`ARTEMIS_AWS_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH_$poolname`
|
|
...
|`aws.mapping.environment-to-image.pattern-map.needle:$poolname`
|
|`ARTEMIS_AWS_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE_$poolname`
|
|
...
|`azure.mapping.environment-to-image.pattern-map.filepath:$poolname`
|
|`ARTEMIS_AZURE_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH_$poolname`
|
|
...
|`azure.mapping.environment-to-image.pattern-map.needle:$poolname`
|
|`ARTEMIS_AZURE_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE_$poolname`
|
|
...
|`beaker.guest-watchdog.ssh.connect-timeout:$poolname`
|
|`ARTEMIS_BEAKER_GUEST_WATCHDOG_SSH_CONNECT_TIMEOUT_$poolname`
|
|
...
|`beaker.job.whiteboard.template:$poolname`
|
|`ARTEMIS_BEAKER_JOB_WHITEBOARD_TEMPLATE_$poolname`
|
|
...
|`beaker.mapping.environment-to-image.pattern-map.filepath:$poolname`
|
|`ARTEMIS_BEAKER_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH_$poolname`
|
|
...
|`beaker.mapping.environment-to-image.pattern-map.needle:$poolname`
|
|`ARTEMIS_BEAKER_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE_$poolname`
|
|
...
|`openstack.mapping.environment-to-image.pattern-map.filepath:$poolname`
|
|`ARTEMIS_OPENSTACK_ENVIRONMENT_TO_IMAGE_MAPPING_FILEPATH_$poolname`
|
|
...
|`openstack.mapping.environment-to-image.pattern-map.needle:$poolname`
|
|`ARTEMIS_OPENSTACK_ENVIRONMENT_TO_IMAGE_MAPPING_NEEDLE_$poolname`
|
|
