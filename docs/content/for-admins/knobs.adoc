...
|`worker.metrics.ttl`
|`int`
|`ARTEMIS_WORKER_METRICS_TTL`
|`120`
|no



5+|How long, in seconds, should various workers metrics remain in cache.

|`worker.metrics.update-tick`
|`int`
|`ARTEMIS_WORKER_METRICS_UPDATE_TICK`
|`60`
|no



5+|How often, in seconds, should various workers update their metrics cache.
