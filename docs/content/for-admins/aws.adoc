...
[WARNING]
====
For older, Xen-based instance types the retrieving of latest output is not possible, so it is more likely to get stale console output logs. Use Nitro-based instances if possible.
====
