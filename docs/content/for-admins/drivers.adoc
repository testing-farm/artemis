...
|[green]#yes#
|[green]#yes#
|See <<aws.adoc#_console_access,"AWS driver">> for configuration details.

|`azure`
|[red]#no#
|[green]#yes#
|See <<azure.adoc#_console_access,"Azure driver">> for configuration details.

|`beaker`
|[yellow]#external#
|[green]#yes#
|See <<beaker.adoc#_console_access,"Beaker driver">> for details.
...
|[green]#yes#
|[red]#no#
|Interactive console URL only. No console log blob.
...
|[green]#yes#
|[green]#yes#
|Full console support via OpenStack API.
