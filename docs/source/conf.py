...
#
# citool documentation build configuration file, created by
...
project = u'citool'
copyright = u'2020, mprchlik@redhat.com, mvadkert@redhat.com and others'
...
latex_documents = [
    (master_doc, 'citool.tex', u'citool Documentation',
...
man_pages = [
    (master_doc, 'citool', u'citool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'citool', u'citool Documentation',
     author, 'citool', 'One line description of project.',
     'Miscellaneous'),
]
...
def setup(app):
    ...
    app.add_stylesheet('fix-argparse-table.css')
